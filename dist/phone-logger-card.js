...
/**
    ...
    `}_renderRow(t){const e=gt(t.status,t.direction),s=mt(t.status,t.direction,this._lang),i="inbound"===t.direction?t.caller_display:t.called_display,o=t.caller_device?.name??null,n=new Date(t.started_at).toLocaleTimeString(this._lang,{hour:"2-digit",minute:"2-digit"}),r=o?`${n} – ${o}`:n;return V`
      <tr
    ...
    `}_renderModal(t){const e=this._lang,s=gt(t.status,t.direction),i=mt(t.status,t.direction,e),o="inbound"===t.direction?t.caller_display:t.called_display,n=t.caller_device,r=(t,e)=>V`
      <tr>
        <td class="modal-label">${t}</td>
        <td class="modal-value">${e}</td>
      </tr>
    `;return V`
      <ha-dialog .open=${!0} @closed=${this._closeModal} .heading=${o}>
        <ha-dialog-header slot="heading">
          <ha-icon-button slot="navigationIcon" dialogAction="cancel">
            <ha-icon icon="mdi:close"></ha-icon>
          </ha-icon-button>
          <span slot="title">${o}</span>
          <ha-icon slot="actionItems" icon=${s.icon} style="color:${s.color}" title=${i}></ha-icon>
        </ha-dialog-header>
        <table class="modal-table">
          ...
          ${r(_t("modal_started",e),$t(t.started_at,e))}
          ${r(_t("modal_connected",e),$t(t.connected_at,e))}
          ${r(_t("modal_finished",e),$t(t.finished_at,e))}
          ${r(_t("modal_duration",e),ft(t.duration_seconds))}
